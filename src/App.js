...
import { Ecommerce, Orders, Employees, Customers, Kanban, Calendar, Stacked, Pyramid, Area, Bar, Pie, Financial, ColorPicker, ColorMapping, Editor, Line } from './pages'
    ...
    <div>
      <BrowserRouter>
        <div className='flex relative dark:bg-main-dark-bg'>
          ...
          {activeMenu ? (
            <div className='w-72 fixed sidebar dark:bg-secondary-dark-bg bg:bg-white'>
                <Sidebar/>
            </div>
          ) : (
